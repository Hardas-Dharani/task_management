...
class CreateEducationScreen extends GetView<CreateEducationController> {
  const CreateEducationScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return GetBuilder<CreateEducationController>(
      init: CreateEducationController(),
      initState: (v) {
