...
class APIProvider {
  ...
  onUnAuthorized() async {
    // Get.find<BottomNavBarController>().writeData(false);
    // Get.find<LocalStorageService>().clearBearerToken();
    // Get.find<LocalStorageService>().userProfileModel = null;
    ...
    try {
      ...
      switch (request.method) {
        case HTTPMethod.get:
          ...
          log('api params ${request.urlParams}');
