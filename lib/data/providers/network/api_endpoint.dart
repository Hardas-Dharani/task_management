class APIEndpoint {
  static String get baseUrl => "tcrm.voxtrongroup.com";
  // https://tcrm.voxtrongroup.com/smart-way/public/api/
  static String get createProposal => "create-proposal";
  static String get createTask => "task";
  ...
  static String get taskDetail => "task";
