class Routes {
  static String get addExperience => '/addExperience';

  static String get addLicenses => '/addLicenses';
  ...
  static String get chatting => '/chatting';

  static String get checkOutScreen => '/checkOutScreen';

  static String get congratulationScreen => '/congratulationScreen';

  static String get consultantDetail => '/consultantDetailScreen';
  ...
  static String get createProProfile => '/createProProfile';
  ...
  static String get getVerified => '/getVerified';
  ...
  static String get quoteCheck => '/quoteCheck';

  static String get quoteDetail => '/quoteDetail';

  static String get recommendedConsultants => '/recommendedConsultants';

  static String get relatedConsultants => '/relatedConsultants';
  ...
  static String get scheduleACallWithAdmin => '/scheduleACallWithAdmin';

  static String get scheduledConsultations => '/scheduledConsultations';

  static String get search => '/search';

  static String get selectCountry => '/selectCountry';

  static String get selectDate => '/selectDate';

  static String get serviceCancellation => '/serviceCancellation';

  static String get serviceDetail => '/serviceDetailScreen';

  static String get servicesList => '/servicesList';
  ...
  static String get topConsultants => '/topConsultants';

  static String get tutorialMenuPro => '/tutorialMenuPro';

  static String get tutorialMenuScreen => '/tutorialMenuScreen';

  static String get tutorialsScreen => '/tutorialsScreen';
  ...
  static String get videoCall => '/videoCall';

  static String get viewFile => '/viewFile';

  static String get virtualBusiness => '/virtualBusiness';

  static String get welcomeScreen => '/welcomeScreen';

  static String get writeAReview => '/writeAReview';
}
